...
class Client
{
    ...
    public function repayFunding(array $params = [])
    {
    ...
    public function withdrawalAddress(array $params = [])
    {
    ...
    public function getProductHistoricStats($productId, array $params = [])
    {
        return $this->getAndDecodeData('products/'.$productId.'/candles', $params);
    }
    
    public function getProductLast24Stats($productId)
    {
